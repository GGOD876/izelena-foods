...
function izelena_assets() {
    wp_enqueue_style('izelena-style', get_stylesheet_uri(), array(), '4.2.1');
    wp_enqueue_script('izelena-interactions', get_template_directory_uri() . '/assets/theme.js', array(), '4.2.1', true);
