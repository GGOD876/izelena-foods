...
function izelena_assets() {
    wp_enqueue_style('izelena-style', get_stylesheet_uri(), array(), '4.2.5');
    wp_enqueue_style('izelena-title-fixes', get_template_directory_uri() . '/assets/title-fixes.css', array('izelena-style'), '4.2.5');
